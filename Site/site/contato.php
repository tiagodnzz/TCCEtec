...
<img src="img/contato.jpg" height="450px" width="1583px">
...
<main class="container"><br>
        ...
        <div class="col-md-5 col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <br>
                    <h5><img src="img/operadoras/email.png" width="20" height="15">&nbsp;&nbsp;e-mails:</h5><br>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form action="contatomsg.php" method="POST">
                <div class="card">
